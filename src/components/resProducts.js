    ...
    <div>
      ...
      >
        <Grid item xs={6} className="gridsNav typo">
                  ...
                  >
                <MenuItem onClick={() => {setAddItemsPage(true); setAnchorEl(null)}}>
                Add Items
                </MenuItem>
                <MenuItem onClick={() => {setAddItemsPage(false); setAnchorEl(null)}}>View Items</MenuItem>
              </Menu>
        </Grid>
                                
        <Grid item xs={6} className="gridsNav typo">
         
           <Button aria-controls="simple-menu" style={{width: "100%", fontSize: 15}} aria-haspopup="true" onClick={menuHandleClick}>Orders<ArrowDropDownIcon/></Button>    
                  <Menu
                    anchorEl={anchorEl2}
                    anchorOrigin={{ vertical: "top", horizontal: "center" }}
                    id="simple-menu"
                  ...
                  >
                <MenuItem onClick={() => {setAddItemsPage(true); setAnchorEl2(null)}}>
                Add Items
                </MenuItem>
                <MenuItem onClick={() => {setAddItemsPage(false); setAnchorEl2(null)}}>View Items</MenuItem>
              </Menu>
        </Grid>
        {/* <hr
          style={{
